...
<body>
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <div class = "user-profile" style = "text-align: center; width: 250px;">
                    	...
                    	<div class = "row">
                    		<div class = "col-xs-6">
                    			<a href = "<?php echo base_url() .'student/logout'?>" ><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    		</div>
                    		<div class = "col-xs-6">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo base_url() .'student/load_progress'?>"><i class="fa fa-bar-chart-o fa-fw"></i> Progress Report</a>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class = "fa fa-bar-chart-o fa-fw"></i> Progress Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
