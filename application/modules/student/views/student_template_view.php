...
<header class="header navbar-inverse">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>SU NOTIFICATION</b></a>
            <!--logo end-->
            ...
            <div class="top-menu">
              <ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?php echo base_url() .'student/logout'?>">Logout</a></li>
              </ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="<?php echo $student['photo']; ?>" class="img-circle" width="60" height = "60"></a></p>
              	  <h5 class="centered"><?php echo $student['firstname'];?> <?php echo $student['lastname'];?></h5>
                 ...
                 <li>
                        ...
                        <li>
                            <a href="<?php echo base_url() .'student/notes'?>"><i class="fa fa-book fa-fw"></i> Notes</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
    ...
    <script src="<?php echo base_url() .'assets/js/dash/jquery-ui-1.9.2.custom.min.js'?>"></script>
    <script src="<?php echo base_url() .'assets/js/dash/jquery.ui.touch-punch.min.js'?>"></script>
    ...
    <script src="<?php echo base_url() .'assets/js/dash/common-scripts.js'?>"></script>
