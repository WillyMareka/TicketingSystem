...
<body>
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a class="active" href="<?php echo base_url() .'student/attendance'?>"><i class="fa fa-users fa-fw"></i> Attendance</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class = "fa fa-users fa-fw"></i> Attendance</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
