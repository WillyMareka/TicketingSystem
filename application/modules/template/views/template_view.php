<html>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<head>
        ...
        <link type="text/css" href="<?php echo base_url().'assets/icons/css/font-awesome.css' ?>" rel="stylesheet">
        <link type="text/css" href='http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600'
            rel='stylesheet'>
            <style type="text/css">
            ul li {
        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu styled" id="my_side">
                            ...
                            <ul class="widget widget-menu unstyled" id="my_side">
