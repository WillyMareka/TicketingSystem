...
<head>
    <head>
        ...
        <title>Edmin</title>
        <link type="text/css" href="<?php echo base_url().'assets/template/bootstrap/css/bootstrap.min.css' ?>" rel="stylesheet">
        <link type="text/css" href="<?php echo base_url().'assets/template/bootstrap/css/bootstrap-responsive.min.css' ?>" rel="stylesheet">
        <link type="text/css" href="<?php echo base_url().'assets/template/css/theme.css' ?>" rel="stylesheet">
        <link type="text/css" href="<?php echo base_url().'assets/template/images/icons/css/font-awesome.css' ?>" rel="stylesheet">
