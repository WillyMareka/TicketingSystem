   ...
   <script src="<?php echo base_url().'assets/js/jquery.dataTables.js';?>" type="text/javascript"></script>
	...
	<script>
		$(document).ready(function() {
			...
			$('.dataTables_paginate > a:first-child').append('<i class="fa fa-chevron-left shaded"></i>');
			$('.dataTables_paginate > a:last-child').append('<i class="fa fa-chevron-right shaded"></i>');
		} );
	</script>
</body>