...
<head>
    <head>
        ...
        <link type="text/css" href="<?php echo baseurl().'css/lecturer_theme.css';?>" rel="stylesheet">
    ...
    <body>
                            ...
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="#" class="btn-box big span4"><i class=" fa fa-random"></i><b>65%</b>
                                        <p class="text-muted">
                                            Growth</p>
                                    </a><a href="#" class="btn-box big span4"><i class="fa fa-user"></i><b>15</b>
                                        <p class="text-muted">
                                            New Users</p>
        ...
        <script src="<?php echo baseurl().'assets/js/jquery-1.9.1.min.js';?>" type="text/javascript"></script>
        <script src="<?php echo baseurl().'assets/js/jquery-ui-1.10.1.custom.min.js';?>" type="text/javascript"></script>
        <script src="<?php echo baseurl().'assets/bootstrap/js/bootstrap.min.js';?>" type="text/javascript"></script>
        <script src="<?php echo baseurl().'assets/bootstrap/js/bootstrap.min.js';?>" type="text/javascript"></script>
        <script src="<?php echo baseurl().'assets/js/jquery.flot.js';?>" type="text/javascript"></script>
        <script src="<?php echo baseurl().'assets/js/jquery.flot.resize.js';?>" type="text/javascript"></script>
        <script src="<?php echo baseurl().'assets/js/jquery.dataTables.js';?>" type="text/javascript"></script>
